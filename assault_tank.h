...
class AssaultTank : public AttackerBase<AssaultTank>
{
 ...
 public:
   AssaultTank(EntityId id, AttackerLook look, sge::MapCoord size, const Attribs& attribs,
...
inline AssaultTank::AssaultTank(EntityId id, AttackerLook look, sge::MapCoord size,
